...
function displayPics(){
  ...
  // The code doesn't work because let, unlike var, is not scoped within the entire enclosing function. Its scope only reaches within the block it is declared and any sub-blocks of that block.
  console.log(viewed)
